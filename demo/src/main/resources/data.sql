...
VALUES (N'iPhone 16 Pro 256GB', 28990000, 31990000, 9, 'HOT', N'Còn 4 suất', 1, N'Chip mới, khung titan, camera zoom ổn định cho người dùng cao cấp.', 'https://img.icons8.com/fluency/240/iphone14-pro.png', (SELECT TOP 1 id FROM categories WHERE name = N'Điện thoại'));

INSERT INTO products (name, price, old_price, discount_percent, badge, status_text, promo, description, image_url, category_id)
VALUES (N'Samsung Galaxy S25 Ultra', 30990000, 33990000, 8, 'AI', N'Quà tặng mở bán', 1, N'Màn hình lớn, bút S Pen, hệ camera nhiều tiêu cự cho công việc và sáng tạo.', 'https://img.icons8.com/fluency/240/android-os.png', (SELECT TOP 1 id FROM categories WHERE name = N'Điện thoại'));
...
INSERT INTO products (name, price, old_price, discount_percent, badge, status_text, promo, description, image_url, category_id)
VALUES (N'ASUS ROG Zephyrus G16', 45990000, 49990000, 8, 'RTX', N'Flash deal tối nay', 1, N'Máy gaming cao cấp, màn 2.5K và GPU mạnh cho chơi game lẫn dựng hình.', 'https://img.icons8.com/fluency/240/laptop.png', (SELECT TOP 1 id FROM categories WHERE name = N'Gaming'));
...
INSERT INTO products (name, price, old_price, discount_percent, badge, status_text, promo, description, image_url, category_id)
VALUES (N'Tay cầm Xbox Wireless', 1490000, 1790000, 17, 'SALE', N'Còn 9 suất', 1, N'Tay cầm kết nối đa nền tảng, cầm chắc, hỗ trợ cloud gaming.', 'https://img.icons8.com/fluency/240/xbox-controller.png', (SELECT TOP 1 id FROM categories WHERE name = N'Gaming'));
...
INSERT INTO products (name, price, old_price, discount_percent, badge, status_text, promo, description, image_url, category_id)
VALUES (N'AirPods Pro Gen 3', 6490000, 7290000, 11, 'APPLE', N'Giao trong 2 giờ', 1, N'Tai nghe true wireless cho hệ sinh thái Apple, khử ồn thông minh.', 'https://img.icons8.com/fluency/240/airpods-pro.png', (SELECT TOP 1 id FROM categories WHERE name = N'Âm thanh'));
